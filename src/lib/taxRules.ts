...
export const TAX_RULES: TaxRule[] = [
  ...
  },
  {
    ...
    notes:
      "POINT DISCUTÉ POUR UN GÉRANT TNS, à connaître avant de s'appuyer sur le chiffre. L'arrêté qui institue cet abattement vise les salariés affiliés au régime général et au régime agricole : un gérant majoritaire, relevant du régime des travailleurs non salariés, est hors de son champ. Les commentateurs professionnels divergent sur son extension à l'évaluation au réel d'un dirigeant de l'art. 62 CGI — certains l'appliquent, d'autres le réservent aux salariés et assimilés. Le simulateur le retient par défaut parce qu'il correspond à la pratique la plus répandue et que l'écarter d'office surestimerait l'avantage — mais le champ « Abattement électrique retenu » permet de basculer sur la position prudente (aucun abattement) et d'en mesurer le coût, sans avoir à fausser l'éco-score du véhicule. La note justificative porte la réserve en toutes lettres. Seul un rescrit social lève définitivement le doute.\n\n" +
      "TROIS RÉGIMES SUCCESSIFS, DISTINGUÉS PAR LA DATE DE MISE À DISPOSITION — et non par le véhicule. Avant le 1er janvier 2020 : aucun abattement. Du 1er janvier 2020 au 31 janvier 2025 (arrêté du 21 mai 2019) : abattement de 50 % SANS aucune condition d'éco-score, la seule motorisation exclusivement électrique suffisait ; un véhicule confié pendant cette fenêtre conserve ce régime. À compter du 1er février 2025 et jusqu'au 31 décembre 2027 (arrêté du 25 février 2025) : le véhicule doit en outre figurer sur la liste des versions atteignant le score environnemental minimal conditionnant le bonus écologique (arrêté du 14 décembre 2023, liste ADEME actualisée périodiquement).\n\n" +
      "CONSÉQUENCE POUR UN VÉHICULE NON ÉCO-SCORÉ CONFIÉ DEPUIS FÉVRIER 2025 : il ne bénéficie d'AUCUN abattement, ni 50 % ni 70 %, et son avantage est évalué selon les règles applicables aux véhicules thermiques. Seule subsiste l'exclusion des frais d'électricité de recharge, qui tient à la motorisation et non à l'éco-score. Modèles généralement éligibles : Tesla Model Y (assemblage Berlin), Renault Megane E-Tech, Renault Scenic E-Tech. Modèle généralement NON éligible : Tesla Model 3 (assemblage Shanghai) — son avantage en nature est donc calculé sans abattement. Liste non exhaustive et évolutive : la vérifier au jour de la mise à disposition.\n\n" +
      "PRÉCISION DU BOSS DU 7 MAI 2026 : si le véhicule n'était pas éco-scoré lors de sa mise à disposition mais intègre ensuite la liste officielle, l'abattement s'applique à compter de la date de publication de cette liste, sans qu'une nouvelle mise à disposition soit nécessaire. Un modèle aujourd'hui exclu peut donc le devenir éligible en cours de contrat.",
  },
  {
